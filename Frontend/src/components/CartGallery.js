...
function CartGallery() {
    ...
    const buyNow = () => {
        cartList.map((item, index) => {
            ...
            if(data.mail === "Mailed"){
                emailjs.send("service_bmy2h0d","template_lrl1ljk",emailParams,"RxeGqyJjzkrqe-RaK")
                  .then(
                    function (response) {
        ...
        <div className='payment-card-container' >
            ...
            <div className='payment-view my-4'>
                ...
                <div className='coupon-card'>
                    <Button onClick={getCoupons} style={{width:"95%",fontWeight:"bold",backgroundColor:"#"}}>
                        Get Coupons
                    </Button>
                </div>
                ...
                <div className="price-card">
                    ...
                    <NavLink to="/user/order-confirm" className='btn btn-danger' onClick={buyNow}>Place Order</NavLink>
                </div>
            </div>
