...
function CartCard(props) {
  ...
  return (
    ...
    <Card style={{ width: '20rem' ,height:'30rem'}}  >
      ...
      <Card.Footer>
        <button type="submit" className="btn btn-success" onClick={removeFromCart}>Remove From Cart</button>
        <button type="submit" className="btn btn-success" onClick={updateCart}>Update Cart</button>
      </Card.Footer>
    </Card>
    </>
  )
